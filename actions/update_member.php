...
$query="UPDATE `membres` SET `fname`='$t_fname',`postnom`='$t_mname',`prenom`='$t_lname',`sex`='$t_sex',`bplace`='$t_bplace',`bday`='$t_bday',`phone`='$t_phone',`member_type`='$user_type',`adress`='$t_adr',`parts`='$parts_account' WHERE `id`='$t_mat'";
