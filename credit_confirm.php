                            ...
                            <div class="card-body">
                                ...
                                <div class="pagecontent">
                                    <div class="title" style="text-align:center">
                                        ...
                                        <h5 style="margin-bottom:45px;" class="card-title">CREDIT ACCORDE</h5>
                                    </div>
                                    ...
                                    <div class="header" style="font-size:16px">
                                        ...
                                        <b>.......montant en
                                            toutes lettres.........</b>) auprès MONEY PROJET TRANSACTION que je compte
                                        rembourser
                                        en
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <input type="text" value="<?php echo $start ?>" class="credit"
                                                            name="mois[]"> </td>
                                                    <td>$ <input type="text" value="<?php echo $mensualite-1 ?>"
                                                            class="credit" name="mens[]"></td>
