...
?>
    ...
    <div class="popup">
        ...
        <h5> Voulez-vous vraiment supprimer le Membre <b><?php echo $names ?></b></h5>
        <p>
        </p>
        <div class="answers" style="display:flex;">
            <a href="./actions/delete_member?id=<?php echo $id ?>">Oui </a>
            <a href="./all_members" style="background:blue;">Non </a>
        </div>
    </div>
