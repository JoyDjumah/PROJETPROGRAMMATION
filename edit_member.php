...
if(isset($_POST["emp_id"]))  
{
    ...
    $query = "SELECT  * FROM membres WHERE id = '".$_POST["emp_id"]."'";  
...
<form class="row g-3" method="POST" action="./actions/update_member.php">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" value="<?php echo $row['fname'] ?>" class="form-control" name="std_fname" id="inputName5" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="inputName5" class="form-label">Post nom </label>
                                    <input type="text" value="<?php echo $row['postnom'] ?>" class="form-control" name="std_mname" id="inputName5" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="inputName5" class="form-label">Prenom </label>
                                    <input type="text" value="<?php echo $row['prenom'] ?>" class="form-control" name="std_lname" id="inputName5" required>
                                </div>
                                <div class="col-md-6 ">
                                    <label class="form-label ">Sexe </label>
                                    <select name="std_sex" class="form-control">
