...
?>
    ...
    <div class="popup">
        ...
        <h5> Voulez-vous vraiment supprimer le credit N° <?php echo $id ?>,  de  <b style="font-size:20px"><?php echo $names ?></b> avec tout ses tranches</h5>
        <p>
        </p>
        <div class="answers" style="display:flex;">
            <a href="./glob_credit_delete?id=<?php echo $id ?>">Oui </a>
            <a href="./all_credits" style="background:blue;">Non </a>
        </div>
    </div>
